...
system.
	% SDSS \citep{Alam2015} 
	%AllWISE 	\citep{Cutri2013} measurements are in the Vega system and the conversion to flux 
	%density are performed using \citet[][Table~1]{Jarrett2011}.
}
\end{deluxetable}
